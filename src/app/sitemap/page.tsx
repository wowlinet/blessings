  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl font-bold font-crimson text-gray-900 dark:text-gray-100 mb-12 text-center">
            Blessing Categories
          </h2>
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-4 mb-4">
                        <a
                          ...
                          className="text-2xl font-bold font-crimson text-gray-900 dark:text-gray-100 hover:text-amber-600 dark:hover:text-amber-400 transition-colors"
                        >
                          {category.title}
                        </a>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                        {category.subcategories.map((sub, subIndex) => (
                          <a
                            ...
                            className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg hover:bg-amber-50 dark:hover:bg-amber-900/30 hover:text-amber-700 dark:hover:text-amber-400 transition-colors group"
                          >
                            <div className="w-2 h-2 bg-amber-400 dark:bg-amber-500 rounded-full group-hover:bg-amber-500 dark:group-hover:bg-amber-400" />
