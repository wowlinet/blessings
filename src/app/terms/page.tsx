      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="text-center">
            <a
              href="/contact"
              className="bg-amber-500 text-white px-8 py-3 rounded-lg font-semibold hover:from-amber-500 hover:to-blue-700 transition-all duration-200 inline-flex items-center gap-2"
            >
